...
description: Remaining cmux CUA platform work, evidence gaps, and operating-system boundaries without implied delivery dates.
---

This roadmap records capability and validation work for cmux CUA. It does not
promise dates. A capability moves to [Platform Support](/reference/cmux-cua/platform-support)
...
alternatives remain documented in [Known Limits](/reference/cmux-cua/limits).
...
[How cmux CUA is validated](/concepts/how-cmux-cua-is-validated).
