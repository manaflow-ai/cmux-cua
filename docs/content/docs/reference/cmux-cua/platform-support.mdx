...
cmux-cua supports Windows, macOS, and Linux. Support is defined by observed
...
tells cmux-cua where the target is, but portal/libei and virtual input still
...
cmux-cua also contains an opt-in exception: the nested `cua-compositor`
...
<Callout type="warn">
  ...
  means cmux-cua refused an unsafe or unsupported route before it could disturb the user's active
  desktop. It is not a silent success.
</Callout>

## Related documentation

- [How cmux CUA is validated](/concepts/how-cmux-cua-is-validated) explains
  why unit tests and application-owned E2E evidence have different roles.
- [Platform roadmap](/reference/cmux-cua/platform-roadmap) records the
  remaining engineering work, evidence gaps, and platform boundaries.
- [Known limits](/reference/cmux-cua/limits) lists target-specific constraints
  and available alternatives.
- [Development](/reference/cmux-cua/development) provides contributor entry
