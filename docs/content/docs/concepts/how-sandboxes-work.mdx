...
cmux CUA operates a real machine you already have. It can observe and control that machine, so its actions happen in the same desktop environment you use.
