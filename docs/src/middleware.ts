...
const redirects: Record<string, string> = {
  ...
  '/cmux-cua': '/docs/cmux-cua/guide/getting-started/introduction',
  '/cmux-cua/guide': '/docs/cmux-cua/guide/getting-started/introduction',
  '/cmux-cua/reference': '/docs/cmux-cua/reference/cli-reference',
