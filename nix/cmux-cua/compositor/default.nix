# cua-compositor: a minimal headless wlroots compositor that cmux-cua spawns
...
stdenv.mkDerivation {
  ...
  meta = {
    description = "Headless wlroots compositor with focus-free + multi-cursor input injection for cmux-cua";
