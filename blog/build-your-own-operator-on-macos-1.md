...
Our Operator will run in an isolated macOS VM, by making use of our [cua-computer](https://github.com/manaflow-ai/cmux-cua/tree/main/libs/python/computer) package and [lume virtualization CLI](https://github.com/manaflow-ai/cmux-cua/tree/main/libs/lume).
...
1. **Lume CLI Setup**
   For installing the standalone lume binary, run the following command from a terminal, or download the [latest pkg](https://github.com/manaflow-ai/cmux-cua/releases/download/lume-v0.2.22/lume-darwin.pkg.tar.gz).
