...
def validate_context(allowlist: PublisherAllowlist) -> None:
    ...
    if required_environment("GITHUB_REF_TYPE", "GitHub ref type") != "tag":
    ...
    if required_environment("GITHUB_REF_PROTECTED", "GitHub ref protection") != "true":
        raise IdentityError("PyPI publishing requires a protected tag ref")
    ...
    if required_environment("GITHUB_REF_NAME", "GitHub ref name") != expected_tag:
        raise IdentityError(
    ...
    if workflow_ref != f"refs/tags/{expected_tag}":
