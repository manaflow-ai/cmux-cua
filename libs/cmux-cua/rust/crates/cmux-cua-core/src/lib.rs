...
//! matching the interface of `libs/cmux-cua` (Swift/macOS) and
//! `CmuxCua.Win` (.NET/Windows).
//!
//! # Protocol
...
pub const RESPONSIBILITY_DISCLAIMED_ENV: &str = "CMUX_CUA_RESPONSIBILITY_DISCLAIMED";

/// Embedded mode (`CMUX_CUA_EMBEDDED=1` / `--embedded`): the driver runs
...
/// See `Skills/cmux-cua/EMBEDDING.md`.
///
...
pub const EMBEDDED_ENV: &str = "CMUX_CUA_EMBEDDED";
...
pub const DEFAULT_SESSION_ENV: &str = "CMUX_CUA_DEFAULT_SESSION";
...
pub const HOST_BUNDLE_ID_ENV: &str = "CMUX_CUA_HOST_BUNDLE_ID";
...
/// it separately.
pub const WATCHABLE_FRONT_ENV: &str = "CMUX_CUA_WATCHABLE_FRONT";
