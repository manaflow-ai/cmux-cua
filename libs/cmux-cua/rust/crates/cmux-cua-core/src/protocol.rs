...
pub fn initialize_result() -> Value {
    serde_json::json!({
        ...
        "capabilities": { "tools": {} },
        "serverInfo": { "name": "cmux-cua", "version": env!("CARGO_PKG_VERSION") },
...
/// no native cmux-cua instructions and a stable non-changing tool catalog.
...
/// workflow in `Skills/cmux-cua/SKILL.md`.
///
...
fn agent_instructions() -> String {
    ...
    format!(
        r#"cmux-cua: cross-platform background computer-use automation.
