...
stub_tool!(get_window_state_m, GetWindowStateTool, "get_window_state",
    ...
    serde_json::json!({"type":"object","required":["pid","window_id"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"window_id":{"type":"integer"},"query":{"type":"string"},"include_screenshot":{"type":"boolean","description":"Default true — returns a grounding screenshot alongside the tree. Set false to skip the grab and return tree only (the cheap path for re-indexing before an element ax action)."},"capture_mode": cmux_cua_core::capture_mode::capture_mode_schema()},"additionalProperties":false}));
...
stub_tool!(click_m, ClickTool, "click",
    ...
    serde_json::json!({"type":"object","required":[],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema(),"x":{"type":"number"},"y":{"type":"number"},"modifier": cmux_cua_core::tool_schema::modifier_schema(),"from_zoom":{"type":"boolean"}},"additionalProperties":false}));
...
stub_tool!(double_click_m, DoubleClickTool, "double_click",
    ...
    serde_json::json!({"type":"object","required":["pid"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"x":{"type":"number"},"y":{"type":"number"},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema()},"additionalProperties":false}));

stub_tool!(right_click_m, RightClickTool, "right_click",
    "Right-click (AT-SPI action on element, or synthesized event at x,y).",
    serde_json::json!({"type":"object","required":["pid"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema(),"window_id":{"type":"integer"},"x":{"type":"number"},"y":{"type":"number"},"modifier": cmux_cua_core::tool_schema::modifier_schema()},"additionalProperties":false}));
...
stub_tool!(type_text_m, TypeTextTool, "type_text",
    ...
    serde_json::json!({"type":"object","required":["pid","text"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"text":{"type":"string"},"element_index": cmux_cua_core::tool_schema::element_index_schema(),"window_id":{"type":"integer"},"x":{"type":"number","description":"Screenshot-pixel X of the field to type into — the element px action form: pixel-click there to focus, then type. Pass with y, no element_index."},"y":{"type":"number","description":"Screenshot-pixel Y of the field (see x)."}},"additionalProperties":false}));
...
stub_tool!(type_chars_m, TypeTextCharsTool, "type_text_chars",
    ...
    serde_json::json!({"type":"object","required":["pid","text"],"properties":{"pid":{"type":"integer"},"text":{"type":"string"},"delay_ms":{"type":"integer"},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema()},"additionalProperties":false}));
...
stub_tool!(press_key_m, PressKeyTool, "press_key",
    ...
    serde_json::json!({"type":"object","required":["pid","key"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"key":{"type":"string"},"modifiers":{"type":"array","items":{"type":"string"}},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema(),"x":{"type":"number","description":"Screenshot-pixel X — the element px action form: pixel-click there to focus, then send the key. Pass with y, no element_index."},"y":{"type":"number","description":"Screenshot-pixel Y (see x)."}},"additionalProperties":false}));

stub_tool!(hotkey_m, HotkeyTool, "hotkey",
    "Press a combination of keys simultaneously, e.g. [\"ctrl\",\"c\"] for Copy.",
    serde_json::json!({"type":"object","required":["pid","keys"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"keys":{"type":"array","items":{"type":"string"},"minItems":2},"x":{"type":"number","description":"Screenshot-pixel X — the element px action form: pixel-click there to focus, then send the combo. Pass with y."},"y":{"type":"number","description":"Screenshot-pixel Y (see x)."}},"additionalProperties":false}));

stub_tool!(set_value_m, SetValueTool, "set_value",
    "Set the value of an AT-SPI element (text field, dropdown, checkbox).",
    serde_json::json!({"type":"object","required":["pid","value"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"pid":{"type":"integer"},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema(),"value":{"type":"string"}},"additionalProperties":false}));
...
stub_tool!(scroll_m, ScrollTool, "scroll",
    ...
    serde_json::json!({"type":"object","required":["direction"],"properties":{"session": cmux_cua_core::tool_schema::session_schema(),"cursor_id":{"type":"string"},"pid":{"type":"integer"},"direction":{"type":"string","enum":["up","down","left","right"]},"by":{"type":"string","enum":["line","page"]},"amount":{"type":"integer","minimum":1,"maximum":50},"window_id":{"type":"integer"},"element_index": cmux_cua_core::tool_schema::element_index_schema()},"additionalProperties":false}));
...
stub_tool!(get_config_m, GetConfigTool, "get_config",
    "Return current cmux-cua configuration.",
    serde_json::json!({"type":"object","properties":{},"additionalProperties":false}));

stub_tool!(set_config_m, SetConfigTool, "set_config",
    "Update cmux-cua configuration.",
    ...
    impl MoveCursorTool {
        pub fn def_static() -> &'static ToolDef {
            DEF.get_or_init(|| ToolDef {
                ...
                input_schema: serde_json::json!({"type":"object","required":["x","y"],"properties":{"x":{"type":"number"},"y":{"type":"number"},"session": cmux_cua_core::tool_schema::session_schema(),"cursor_id":{"type":"string"}},"additionalProperties":false}),
...
pub fn build_registry() -> cmux_cua_core::tool::ToolRegistry {
    let mut r = cmux_cua_core::tool::ToolRegistry::new();
    ...
    r.register(Box::new(cmux_cua_core::health_report::HealthReportTool::new(
