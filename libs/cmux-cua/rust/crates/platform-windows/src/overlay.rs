...
//!
//! Matches the C# reference in CmuxCua.Win/Cursor/AgentCursorOverlay.cs:
//!
...
unsafe extern "system" fn wnd_proc(
    ...
    match msg {
        WM_TIMER => {
            ...
            // Set CMUX_CUA_OVERLAY_FPS_FILE=<path> to append a measured
            ...
            // unset this is a single OnceLock read + branch (no behaviour change).
            {
                ...
                if let Some(path) =
                    FPS_PATH.get_or_init(|| std::env::var("CMUX_CUA_OVERLAY_FPS_FILE").ok())
                {
