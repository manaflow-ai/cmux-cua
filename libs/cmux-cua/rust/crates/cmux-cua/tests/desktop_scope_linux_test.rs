...
//! cmux-cua interface as Windows/macOS: `set_config capture_scope=desktop` +
...
//!   cargo test -p cmux-cua --test desktop_scope_linux_test -- --ignored --nocapture --test-threads=1
