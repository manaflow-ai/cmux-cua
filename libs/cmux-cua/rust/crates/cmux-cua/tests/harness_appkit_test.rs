...
//! The harness app lives at `libs/cmux-cua/tests/fixtures/apps/macos/appkit`
//! and is published into `libs/cmux-cua/rust/test-apps/harness-appkit/`
//! by `libs/cmux-cua/tests/fixtures/build/macos.sh`.
//!
//! Scenarios (see `libs/cmux-cua/tests/fixtures/shared/scenarios.json`
//! `appkit` section):
...
//!
//! Run locally (after `libs/cmux-cua/tests/fixtures/build/macos.sh`):
...
use cmux_cua_testkit::ax::{element_index_by_id, element_index_containing, has_id, looks_empty};
use cmux_cua_testkit::e2e::{
...
use cmux_cua_testkit::observer::TargetWindow;
use cmux_cua_testkit::sentinel::run_with_background_oracles;
use cmux_cua_testkit::{Driver, McpDriver, ToolResponse};
...
fn harness_app() -> PathBuf {
    ...
    cmux_cua_testkit::harness_app("harness-appkit", "CuaTestHarness.AppKit.app")
}
...
fn run_case(
    case: cmux_cua_testkit::e2e::CaseSpec,
    ...
    execute_case(case, |evidence| {
        ...
        *evidence = recording_evidence(driver.recording_dir());
        ...
        if delivery != cmux_cua_testkit::e2e::Delivery::Background {
