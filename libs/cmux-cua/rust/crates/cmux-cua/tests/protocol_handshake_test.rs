...
fn initialize_handshake() {
    ...
    // The server reports "cmux-cua" on every platform. (The old Windows
    // mirror asserted a stale "cmux-cua"; it had never been run.)
    assert_eq!(resp["result"]["serverInfo"]["name"], "cmux-cua");
