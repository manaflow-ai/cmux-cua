# cmux CUA Test Matrix

This is the source map for the Rust test suites in `libs/cmux-cua`. It uses
...
| MCP and CLI boundary | `rust/crates/cmux-cua/tests/protocol_*` | Handshake, tool registration, tool calls, media, sessions, and errors |
...
- `rust/crates/cmux-cua/tests/cross_platform_behavior_test.rs`
...
| --- | --- | --- |
| Linux unit/source | Nix Linux CI | `nix build .#checks.x86_64-linux.cmux-cua-build .#checks.x86_64-linux.cmux-cua-linux-rust-unit` |
