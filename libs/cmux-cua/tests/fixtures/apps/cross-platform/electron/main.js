...
// index.html that CuaTestHarness.WebView also loads. cmux-cua's `page`
...
function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    show: !sentinelMode,
    // A floating-level macOS window is omitted by cmux-cua's deliberate
  ...
  // cmux-cua tests can find the window by substring match. Without this,
  // Electron syncs window.title to document.title which would be
  // 'cmux-cua Web Harness' (the page's title).
